...
exports.archiveServicesVariantsImagesData = void 0;
exports.archivesServicesData = archivesServicesData;
exports.servicesVariationsData = exports.servicesImages = exports.servicesData = exports.servicesAttributesData = void 0;
const servicesData = exports.servicesData = [{
...
const totalImagesByService = [3, 2, 3, 1, 2, 3, 2, 2, 2, 2]; // 10

const servicesImages = exports.servicesImages = totalImagesByService.map(t => Array.from({
  length: t
}, (_, i) => i));
function archivesServicesData(index, id) {
...
const servicesAttributesData = exports.servicesAttributesData = [{
  name: 'Oleo',
  // Troca de oleo 0
  product_id: '',
...
const servicesVariationsData = exports.servicesVariationsData = [{
  price: 350,
  // oleo
  quantity: 1,
  name: 'premium',
...
const archiveServicesVariantsImagesData = exports.archiveServicesVariantsImagesData = [{
