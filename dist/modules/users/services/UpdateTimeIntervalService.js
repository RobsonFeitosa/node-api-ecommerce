...
let UpdateTimeIntervalService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('TimeIntervalsRepository')(target, undefined, 0);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _ITimeIntervalsRepository.default === "undefined" ? Object : _ITimeIntervalsRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class UpdateTimeIntervalService {
  constructor(timeIntervalsRepository) {
    this.timeIntervalsRepository = timeIntervalsRepository;
  }
  async execute(data, professionalId) {
    const timeIntervals = await this.timeIntervalsRepository.findByProfessionalId(professionalId);
    console.log({
      timeIntervals
    });
...
var _default = exports.default = UpdateTimeIntervalService;