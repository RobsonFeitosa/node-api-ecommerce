...
var _ProductWish = _interopRequireDefault(require("../../../../products/infra/typeorm/entities/ProductWish"));
...
let User = (_dec = (0, _typeorm.Entity)('users'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)(), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.Column)(), _dec9 = (0, _classTransformer.Exclude)(), _dec10 = Reflect.metadata("design:type", String), _dec11 = (0, _typeorm.Column)(), _dec12 = (0, _classTransformer.Exclude)(), _dec13 = Reflect.metadata("design:type", String), _dec14 = (0, _typeorm.OneToOne)(() => _UserSettings.default, {
  onDelete: 'CASCADE'
}), _dec15 = (0, _typeorm.JoinColumn)({
  name: 'settings_id'
}), _dec16 = Reflect.metadata("design:type", typeof _UserSettings.default === "undefined" ? Object : _UserSettings.default), _dec17 = (0, _typeorm.OneToMany)(() => _ProductWish.default, wish => wish.user), _dec18 = Reflect.metadata("design:type", Array), _dec(_class = (_class2 = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "settings_id", _descriptor5, this);
    _initializerDefineProperty(this, "settings", _descriptor6, this);
    // @OneToMany(() => UserComments, (comment) => comment.user)
    // comment: UserComments[]
    _initializerDefineProperty(this, "wishes", _descriptor7, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "settings_id", [_dec11, _dec12, _dec13], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "settings", [_dec14, _dec15, _dec16], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "wishes", [_dec17, _dec18], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
