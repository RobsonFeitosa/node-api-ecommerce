...
let DeleteProductAttributeService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute(productId, attributeId) {
    ...
    if (!attribute) {
      throw new _AppError.default('Attribute not exist');
    }
    await this.productAttributesRepository.delete(attributeId);
  }
}) || _class) || _class) || _class) || _class) || _class);
var _default = exports.default = DeleteProductAttributeService;