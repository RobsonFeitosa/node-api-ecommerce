...
let ProductWish = (_dec = (0, _typeorm.Entity)('pd102_product_wish'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = (0, _classTransformer.Exclude)(), _dec6 = Reflect.metadata("design:type", String), _dec7 = (0, _typeorm.OneToOne)(() => _Product.default), _dec8 = (0, _typeorm.JoinColumn)({
  name: 'product_id'
}), _dec9 = Reflect.metadata("design:type", typeof _Product.default === "undefined" ? Object : _Product.default), _dec10 = (0, _typeorm.Column)(), _dec11 = (0, _classTransformer.Exclude)(), _dec12 = Reflect.metadata("design:type", String), _dec13 = (0, _typeorm.ManyToOne)(() => _User.default, user => user.wishes), _dec14 = (0, _typeorm.JoinColumn)({
  name: 'user_id'
}), _dec15 = Reflect.metadata("design:type", typeof _User.default === "undefined" ? Object : _User.default), _dec16 = (0, _typeorm.CreateDateColumn)(), _dec17 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec18 = (0, _typeorm.UpdateDateColumn)(), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = class ProductWish {
  constructor() {
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "product_id", [_dec4, _dec5, _dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "user_id", [_dec10, _dec11, _dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "user", [_dec13, _dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var _default = exports.default = ProductWish;